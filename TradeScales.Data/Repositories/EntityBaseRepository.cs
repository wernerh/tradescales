...
namespace TradeScales.Data.Repositories
{
    ...
    {
        private TradeScalesContext dataContext;
        ...
        protected TradeScalesContext DbContext
        {
        ...
        {
            DbEntityEntry dbEntityEntry = DbContext.Entry<T>(entity); dbEntityEntry.State = EntityState.Deleted;
        }
    }
}
