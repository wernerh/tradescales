...
namespace WBS.Wpf.ViewModel.Dialogs
{
    public class ActivateViewModel : BaseViewModel
    {
        ...
        private string BuildExplainProcessMessage()
        {
            ...
            builder.AppendLine("In order to activate your installation of Weighbridge System, it is necessary to request a license code from Weighbridge System (Step 1) " +
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.AppendLine("The first step requires you to email the auto-generated unique identifier to Info@thinkit.co.za. " +
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.AppendLine("License code - this is the 256 character-string contained in the reply email from Weighbridge System. The expiry date of the license code issued will also be included in this email." +
