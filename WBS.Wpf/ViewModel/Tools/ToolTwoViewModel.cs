...
namespace WBS.Wpf.ViewModel.Tools
{
    ...
    public class ToolTwoViewModel : ToolViewModel
    {
        ...
        {
            var result = @"<table><tr><th style=""font-weight: bold"">Ticket No</th><th style=""font-weight: bold"">Date Out</th><th style=""font-weight: bold"">Time Out</th><th style=""font-weight: bold"">Driver</th><th style=""font-weight: bold"">Registration</th><th style=""font-weight: bold"">Order No</th><th style=""font-weight: bold"">Delivery No</th><th style=""font-weight: bold"">Gross</th><th style=""font-weight: bold"">Tare</th><th style=""font-weight: bold"">Net</th></tr>";
            ...
            var totalnet = tickets.Sum(x => x.NettWeight);

            result += $"<tr><td>Grand Total:</td><td></td><td></td><td></td><td></td><td></td><td></td><td>{totalGross}</td><td>{totalTare}</td><td>{totalnet}</td></tr>";
            result += "</table>";
