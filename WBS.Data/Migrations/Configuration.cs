namespace WBS.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WBSContext>
    {
        ...
        protected override void Seed(WBSContext context)
        {
            // Create Customers
        ...
        private StatusMessage[] GenerateStatusMessages()
        {
           ...
           {
                new StatusMessage(){Type = "SUCCESS", Message = "Welcome to our Early Access Program for WBS."},
                new StatusMessage(){Type = "SUCCESS", Message = "We are glad to have you on board, because your feedback will help us make the production release of WBS fully functional with lots of new and useful features."}
           };
