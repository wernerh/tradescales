...
using TradeScales.Properties;
using TradeScales.Resources.Services.Interfaces;
using TradeScales.ViewModel.Tools;
using Xceed.Wpf.AvalonDock.Themes;
using MVVMRelayCommand = TradeScales.Model.RelayCommand;
    ...
    public class MainViewModel : BaseViewModel
    {
        ...
        public string DialogTitle
        {
            get
            {
                ...
                {
                    _DialogTitle = $"Trade Scales {Assembly.GetEntryAssembly().GetName().Version}";
                }
                return _DialogTitle;
            }
        }
        ...
        public void ChangeAppTheme()
        {
            ...
            string themeWorkbench = Settings.Default.WorkBenchTheme;
